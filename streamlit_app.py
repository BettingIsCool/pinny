...
selected_leagues = st.multiselect(label='Leagues', options=list(leagues.keys()), format_func=lambda x: leagues.get(x), placeholder='Start typing...', help='Please select the leagues you need the data for.')
