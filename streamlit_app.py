...
selected_leagues = st.multiselect(label='Leagues', options=leagues.keys().sort(), format_func=lambda x: leagues.get(x), placeholder='Start typing...', help='Please select the leagues you need the data for.')
